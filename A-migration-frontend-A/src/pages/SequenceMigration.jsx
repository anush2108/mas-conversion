...
const SequenceMigration = () => {
  ...
  const fetchSequences = async (schema) => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:8000/sequences${apiPrefix}/${schema}/list`);
  ...
  const startMigration = () => {
    ...
    const url = `http://localhost:8000/sequences/migrate/stream?source_type=${sourceDbType}&schema=${selectedSchema}&transaction_id=${transactionId}`;
